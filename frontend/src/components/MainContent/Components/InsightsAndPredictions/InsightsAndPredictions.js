...
import { MdHealthAndSafety, MdInsights, MdKeyboardArrowDown } from "react-icons/md";
      ...
      <div className="flex flex-col p-2 mb-4 mx-2 md:mx-3 lg:mx-4 mt-4">
        ...
        <div className="min-h-full h-full overflow-y-auto scroll-smooth p-2 mt-2">
          <div className="flex flex-col gap-2 items-start justify-start w-full">
            ...
            <div
              className={`flex flex-col gap-1 w-full shadow-md`}
            >
              <div className={`flex justify-between items-center shadow-bottom w-full`}>
                <div className="flex gap-1">
                  <MdHealthAndSafety className={`size-5 md:size-6 lg:size-7 text-${selectedTheme}-800`}/>
                  <p
