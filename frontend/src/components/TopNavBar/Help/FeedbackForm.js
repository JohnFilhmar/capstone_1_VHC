    ...
    >
      <div className="flex flex-col text-xs md:text-sm lg:text-base">
        ...
        >
          ...
          <p
            className={`text-xs text-${selectedTheme}-700 font-thin mb-4 p-2 bg-${selectedTheme}-50 rounded-lg text-center`}
          >
          ...
          <div className="flex justify-end items-center gap-2 mt-4">
            ...
            <button
              ...
              className={`py-2 px-4 hover:shadow-md font-semibold rounded-lg transition-colors duration-200 ${
                formData.feedbackDetails && formData.area
                  ? `text-${selectedTheme}-100 bg-${selectedTheme}-600 hover:cursor-pointer shadow-sm`
                  : `shadow-inner text-${selectedTheme}-200 bg-${selectedTheme}-500 hover:cursor-not-allowed`
              }`}
              disabled={!formData.feedbackDetails && !formData.area}
            >
              Submit Feedback
            </button>
          </div>
